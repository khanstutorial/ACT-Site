...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">ACT Tutoring - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">ACT Tutoring</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("ACT Tutoring -Khan's Tutorial</title>",nbrhood.replace('-',' ')+" ACT Tutoring - Khan's Tutorial</title>")
    newBString = bannerString.replace("ACT Tutoring</h1>",nbrhood.replace('-',' ')+" ACT Tutoring</h1>")
